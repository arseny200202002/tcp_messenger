...
session_fields =        [Sessions.user_id, Sessions.last_update_time, Sessions.state, Sessions.address, Sessions.port, Sessions.is_guest]
...
sessions_data = [(1001, now, 0, '127.0.0.0', 5000, False),
                 (1002, now, 0, '127.0.0.0', 5001, False),
                 (1003, now, 0, '127.0.0.0', 5002, False),
                 (1004, now, 0, '127.0.0.0', 5003, False),]
